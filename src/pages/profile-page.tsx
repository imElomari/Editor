            ...
            <Card className="border border-border/40 shadow-lg overflow-hidden relative">
              ...
              <CardHeader className="relative z-10 pb-0">
                <div className="flex flex-col items-center">
                  ...
                  <CardDescription className={cn("flex items-center mt-1", isRTL && "flex-row-reverse")}>
                    <Icons.mail className={cn("h-4 w-4 text-muted-foreground", isRTL ? "ml-1" : "mr-1")} />
                    {user?.email}
                  </CardDescription>
                </div>
              </CardHeader>
              ...
              <CardContent className="pt-8 pb-6 relative z-1">
                <div className="grid gap-6 md:grid-cols-2">
                  <InfoCard
                    ...
                    value={user.created_at ? new Date(user.created_at).toLocaleString(i18n.language) : "N/A"}
                    isRTL={isRTL}
                  />
                  ...
                  <InfoCard
                    ...
                    value={user.updated_at ? new Date(user.updated_at).toLocaleString(i18n.language) : "N/A"}
                    isRTL={isRTL}
                  />
                  ...
                  <InfoCard
                    ...
                    value={user.last_sign_in_at ? new Date(user.last_sign_in_at).toLocaleString(i18n.language) : "N/A"}
                    isRTL={isRTL}
                  />
                  ...
                  <InfoCard
                    icon={
                      <Icons.success
                        className={cn("h-5 w-5", user.email_confirmed_at ? "text-green-500" : "text-yellow-500")}
                      />
                    }
                ...
                <div className="space-y-4">
                  <div className={cn("flex items-start gap-4", isRTL && "flex-row-reverse")}>
                    ...
                    <div className={cn("space-y-2 flex-1", isRTL && "text-right")}>
                      ...
                      {resetSent && (
                        ...
                        >
                          ...
                          <div>
                            ...
                            <AlertDescription>{t("profile:page.tab2.password_reset.check")}</AlertDescription>
                          </div>
                        </Alert>
                      )}
                      ...
                      >
                        {resetLoading && (
                          <Icons.loading className={cn("h-4 w-4 animate-spin", isRTL ? "ml-2" : "mr-2")} />
                        )}
                    ...
                    <div className={cn("space-y-2", isRTL && "text-right")}>
                      ...
                      <div className={isRTL ? "rtl-bullet-list" : ""}>
                        <ul className="space-y-2 text-sm text-muted-foreground">
                          <li className={isRTL ? "rtl-bullet-item" : "ml-5"}>{t("profile:page.tab2.tips.1")}</li>
                          <li className={isRTL ? "rtl-bullet-item" : "ml-5"}>{t("profile:page.tab2.tips.2")}</li>
                          <li className={isRTL ? "rtl-bullet-item" : "ml-5"}>{t("profile:page.tab2.tips.3")}</li>
                          <li className={isRTL ? "rtl-bullet-item" : "ml-5"}>{t("profile:page.tab2.tips.4")}</li>
                          <li className={isRTL ? "rtl-bullet-item" : "ml-5"}>{t("profile:page.tab2.tips.5")}</li>
                        </ul>
                      </div>
                    </div>
                  </div>
