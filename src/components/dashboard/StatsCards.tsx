    ...
    <div className={cn("grid gap-4 mb-8", isMobile ? "grid-cols-2" : "sm:grid-cols-2 lg:grid-cols-4")}>
      <Suspense fallback={<StatsCardSkeleton />}>
        ...
        <CardHeader className="pb-2 relative">
          <div className={cn("flex items-center justify-between", isRTL && "rtl")}>
            <CardTitle className={cn("text-sm font-medium",isRTL && "rtl")}>{t("dashboard:cards.labels.title")}</CardTitle>
      ...
      <Card className="overflow-hidden relative group">
        ...
        <CardContent className="relative">
          ...
          <p className={cn("text-sm text-muted-foreground mt-2 flex items-center gap-1", isRTL && "flex-row-reverse")}>
      ...
      <Card className="overflow-hidden relative group">
        ...
        <CardContent className="relative">
          <div className="text-3xl sm:text-4xl font-bold tracking-tight">{stats.totalAssets}</div>
          <p className={cn("text-sm text-muted-foreground mt-2 flex items-center gap-1", isRTL && "flex-row-reverse")}>
      ...
      <Card className="overflow-hidden relative group">
        ...
        <CardHeader className="pb-2 relative">
          <div className={cn("flex items-center justify-between", isRTL && "flex-row-reverse")}>
            <CardTitle className="text-sm font-medium">{t("dashboard:cards.recent.title")}</CardTitle>
      ...
      >
        ...
        <CardHeader className="pb-2 relative">
          <div className={cn("flex items-center justify-between", isRTL && "flex-row-reverse")}>
            <CardTitle className="text-sm font-medium">{t("dashboard:cards.quickCreate.title")}</CardTitle>
